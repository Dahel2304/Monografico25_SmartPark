    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/usuarios").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.POST, "/usuarios").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.PUT, "/usuarios/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.PATCH, "/usuarios/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.DELETE, "/usuarios/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/configuracion/empresa").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.PUT, "/configuracion/empresa").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/tarifas").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.PUT, "/tarifas").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                ...
                .requestMatchers(HttpMethod.GET, "/reportes/bootstrap").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/operativos").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/operativos/**").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                ...
                .requestMatchers(HttpMethod.GET, "/reportes/consultas/**").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/financieros").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/financieros/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/comparativos").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/comparativos/**").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/eficiencia").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/eficiencia/**").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
